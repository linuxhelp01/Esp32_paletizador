...
- mover el target X/Y con el raton sobre el plano de trabajo
...
- `palletizer.urdf` para la estructura cinemática
...
- mantén los ejes del CAD coherentes con el robot real
...
URDF trabaja en metros. Si el STL exportado en mm aparece 1000 veces más grande,
