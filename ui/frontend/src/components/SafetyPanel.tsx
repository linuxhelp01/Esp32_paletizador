...
export function SafetyPanel({ state, send }: Props) {
  ...
  const notOperative = !readiness.operative && !readiness.hasFault;
  ...
  return (
    <section className="section safety machine-state">
      ...
      <div className="state-stack">
        ...
        <div className={notOperative ? "state-card warn active" : "state-card warn"}><strong>!</strong><span>No operativo</span></div>
